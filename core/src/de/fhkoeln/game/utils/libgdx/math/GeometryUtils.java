...
package de.fhkoeln.game.utils.libgdx.math;
...
public abstract class GeometryUtils {
	 ...
	 *  @see de.fhkoeln.game.utils.math.MathUtils#between(float, float, float) */
	public static boolean between(Vector2 point, Vector2 a, Vector2 b, boolean inclusive) {
		return det(a.x, a.y, point.x, point.y, b.x, b.y) == 0 && de.fhkoeln.game.utils.math.MathUtils.between(point.x, a.x, b.x, inclusive) && de.fhkoeln.game.utils.math.MathUtils.between(point.y, a.y, b.y, inclusive);
	}
