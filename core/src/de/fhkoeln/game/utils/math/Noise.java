...
package de.fhkoeln.game.utils.math;

import static de.fhkoeln.game.utils.ArrayUtils.wrapIndex;

import de.fhkoeln.game.utils.Accessor;
...
public abstract class Noise {
	...
	/** the {@link java.util.Random} used to generate pseudo-random values */
	...
	/** a copy of {@link com.badlogic.gdx.math.MathUtils#random(float, float)} using the {@link #random Random object} of {@link de.fhkoeln.game.utils.math.Noise}
