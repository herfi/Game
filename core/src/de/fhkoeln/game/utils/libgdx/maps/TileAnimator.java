...
import static de.fhkoeln.game.utils.libgdx.maps.MapUtils.toTiledMapTileArray;

/** Animates the tiles in a {@link com.badlogic.gdx.maps.tiled.TiledMapTileLayer tile map layer} by replacing them with {@link com.badlogic.gdx.maps.tiled.tiles.AnimatedTiledMapTile animated tiles}.<br>
 * 
 ...
 *  You can put a property with the desired interval for each animation in the properties of the frame that defines the position of the animation on the map. Note that you cannot define a different for each frame since this is not supported by the {@link com.badlogic.gdx.maps.tiled.tiles.AnimatedTiledMapTile animated tiles}.<br>
...
public abstract class TileAnimator {
	 ...
	 *  @param tiles the tiles to create {@link com.badlogic.gdx.maps.tiled.tiles.AnimatedTiledMapTile animated tiles} from
	 *  @param layer the target {@link com.badlogic.gdx.maps.tiled.TiledMapTileLayer layer}
	...
	/** @see #animateLayer(com.badlogic.gdx.maps.tiled.TiledMapTile[], com.badlogic.gdx.maps.tiled.TiledMapTileLayer, String, String, String, float) */
	...
	/** animates the {@link com.badlogic.gdx.maps.tiled.TiledMapTileLayer target layer} using the given animations
	 *  @param animations the animations to use
	 *  @param layer the {@link com.badlogic.gdx.maps.tiled.TiledMapTileLayer} which tiles to animate
	 *  @param animationKey the key used to tell if a tile is a frame
	 *  @param intervalKey the key used to get the animation interval (duration each frame is displayed)
	 ...
	 *  @param animationKey the key used to tell if a tile is a frame
	 *  @return an {@link com.badlogic.gdx.utils.ObjectMap} which values are tiles that are frames and which keys are their animation names */
	 ...
	 *  @see #sortFrames(com.badlogic.gdx.utils.Array, String) */
