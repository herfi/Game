...
import de.fhkoeln.game.utils.Appender;

import com.badlogic.gdx.math.Interpolation;

/** A Typewriter writing a {@code CharSequence}.<br>
 *  Uses a {@link CharSequenceInterpolator} and {@link Appender}, so {@link com.badlogic.gdx.math.Interpolation Interpolations} and custom {@link Appender#setAppendices(CharSequence[]) cursors} can be used.
 *  @author dermetfan */
