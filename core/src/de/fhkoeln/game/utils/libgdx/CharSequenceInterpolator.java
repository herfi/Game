...
public class CharSequenceInterpolator {
	...
	/** @see #interpolate(CharSequence, float, float, int, int, com.badlogic.gdx.math.Interpolation) */
	 ...
	 *  @param endIndex the index at which the returned {@code CharSequence} should end if the given {@code Interpolation} {@link com.badlogic.gdx.math.Interpolation#apply(float, float, float) applied} 1
	...
	/** the {@link com.badlogic.gdx.math.Interpolation} to use */
	...
	/** @see #interpolate(CharSequence, float, float, com.badlogic.gdx.math.Interpolation) */
