...
package de.fhkoeln.game.utils.libgdx.maps;
...
import static de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format.Base64;
import static de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format.Base64Gzip;
import static de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format.Base64Zlib;
import static de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format.CSV;
import static de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format.XML;
...
public class TmxMapWriter extends XmlWriter {
	...
	/** The height of a layer <strong>IN PIXELS</strong>, to invert the y-axis. {@link #setLayerHeight(int) Set} this explicitly if you want to write something that does not know the layer size, like a {@link #tmx(com.badlogic.gdx.maps.MapLayer) single} or {@link #tmx(com.badlogic.gdx.maps.MapLayers, de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format) multiple} layers or {@link #tmx(com.badlogic.gdx.maps.MapObject) object}{@link #tmx(com.badlogic.gdx.maps.MapObjects) s}. */
	private int layerHeight;

	/** creates a new {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} using the given {@link java.io.Writer} */
	public TmxMapWriter(Writer writer) {
		super(writer);
	}

	/** @param map the {@link com.badlogic.gdx.maps.Map} to write in TMX format
	...
	/** @param properties the {@link com.badlogic.gdx.maps.MapProperties} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	public TmxMapWriter tmx(MapProperties properties) throws IOException {
		return tmx(properties, null);
	}

	/** writes nothing if the given {@link com.badlogic.gdx.maps.MapProperties} are empty or every key is excluded
	 *  @param properties the {@link com.badlogic.gdx.maps.MapProperties} to write in TMX format
	...
	/** @param sets the {@link com.badlogic.gdx.maps.tiled.TiledMapTileSets} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	...
	/** @param set the {@link com.badlogic.gdx.maps.tiled.TiledMapTileSet} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	...
	/** @param layers the {@link com.badlogic.gdx.maps.MapLayers}
	 *  @param format the {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter.Format} to use
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	...
	/** @param layer the {@link com.badlogic.gdx.maps.MapLayer} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	...
	/** @param objects the {@link com.badlogic.gdx.maps.MapObject} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
	...
	/** @param object the {@link com.badlogic.gdx.maps.MapObject} to write in TMX format
	 *  @return this {@link de.fhkoeln.game.utils.libgdx.maps.TmxMapWriter} */
