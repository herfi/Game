...
public abstract class MapUtils {
	...
	/** Finds a property in an array of {@link com.badlogic.gdx.maps.MapProperties}. If multiple {@link com.badlogic.gdx.maps.MapProperties} contain the value, the later given one's value is returned.
	 *  @param key the key
	 *  @param defaultValue the default value
	 *  @param properties the {@link com.badlogic.gdx.maps.MapProperties} to search
	 ...
	 *  @param properties the {@link com.badlogic.gdx.maps.MapProperties} to get the value from
	...
	/** creates an array of TiledMapTiles from a {@link com.badlogic.gdx.maps.tiled.TiledMapTileSet}
	 * @param tiles the {@link com.badlogic.gdx.maps.tiled.TiledMapTileSet} to create an array from
	...
	/** sets the given Vector2 to the max width and height of all {@link com.badlogic.gdx.maps.tiled.TiledMapTileLayer tile layers} of the given map
