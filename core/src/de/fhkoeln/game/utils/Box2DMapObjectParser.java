 ...
 *  In your object layer, right-click an object and set its properties to those of the Body/Fixture/both (in case you're creating an {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#object object}) you'd like, as defined in the used {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} object.<br>
 *  For type, you have to choose {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#body}, {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#fixture} or {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#object}.<br>
 *  To add Fixtures to a Body, add a {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#body} property with the same value to each Fixture of a Body.<br>
 *  To create {@link com.badlogic.gdx.physics.box2d.Joint Joints}, add any object to the layer and just put everything needed in its properties. Note that you use the editors unit here which will be converted to Box2D meters automatically using {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#unitScale}.
 *  <br>
...
public class Box2DMapObjectParser {
	...
	/** Allows modification of {@link com.badlogic.gdx.maps.MapObject MapObjects} before they are used to create Box2D objects.<br>
	 *  <strong>Note that the map object given to you is the one directly from the map, so if you modify it, you modify the {@link com.badlogic.gdx.maps.Map} instance! If you want to avoid that, make a copy.</strong><br>
	 *  Also listens to Box2D objects that have been created.
	 *  @author dermetfan */
	public static interface Listener {

		/** @param parser the {@link de.fhkoeln.game.utils.Box2DMapObjectParser} instance that is going to {@link de.fhkoeln.game.utils.Box2DMapObjectParser#load(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.Map) process} a map */
		public void init(Box2DMapObjectParser parser);

		/** @param map the {@link com.badlogic.gdx.maps.Map} to load from
		 *  @param queue the {@link com.badlogic.gdx.maps.MapLayer MapLayers} to actually parse */
		public void load(Map map, Array<MapLayer> queue);

		/** @param layer the {@link com.badlogic.gdx.maps.MapObject MapObjects} in the layer
		 *  @param queue the {@link com.badlogic.gdx.maps.MapObject MapObjects} to actually parse */
	...
	/** @see de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases */
	private Aliases aliases = new Aliases();

	/** the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener} used by default (an {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener.Adapter} instance) */
	public static final Listener.Adapter defaultListener = new Listener.Adapter();

	/** the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener} to use ({@link #defaultListener} by default) */
	...
	/** if the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#unitScale unit scale} found in the map should be ignored */
	private boolean ignoreMapUnitScale;

	/** if the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#unitScale unit scale} found in the layers should be ignored */
	...
	/** the properties {@link com.badlogic.gdx.maps.MapObject MapObjects} will inherit in {@link #createBody(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.MapObject)}, {@link #createFixture(com.badlogic.gdx.maps.MapObject)} and {@link #createJoint(com.badlogic.gdx.maps.MapObject)} */
	...
	/** the {@link com.badlogic.gdx.maps.MapProperties} of the currently {@link #load(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.Map) loading} map */
	private MapProperties mapProperties;

	/** the {@link com.badlogic.gdx.maps.MapProperties} of the currently {@link #load(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.MapLayer) loading} layer */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} with the default {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} */
	public Box2DMapObjectParser() {}

	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases}
	 *  @param aliases the {@link #aliases} to use */
	public Box2DMapObjectParser(Aliases aliases) {
		this.aliases = aliases;
	}

	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener}
	 *  @param listener the {@link #listener} to use */
	public Box2DMapObjectParser(Listener listener) {
		this.listener = listener;
	}

	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} and {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener}
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param aliases the {@link #aliases}
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param listener the {@link #listener}
	 *  @param tileWidth the {@link #tileWidth}
	 *  @param tileHeight the {@link #tileHeight} */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener}, {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param aliases the {@link #aliases}
	 *  @param listener the {@link #listener}
	 *  @param tileWidth the {@link #tileWidth}
	 *  @param tileHeight the {@link #tileHeight} */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link #unitScale unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param unitScale the {@link #unitScale unitScale} to use */
	public Box2DMapObjectParser(float unitScale) {
		this.unitScale = unitScale;
	}

	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link #unitScale}, {@link #tileWidth}, {@link #tileHeight} and sets {@link #ignoreMapUnitScale} to true
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param unitScale the {@link #unitScale} to use */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param listener the {@link #listener} to use
	 *  @param unitScale the {@link #unitScale} to use */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} using the given {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases}, {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param listener the {@link #listener} to use
	 *  @param unitScale the {@link #unitScale} to use */
	...
	/** creates a new {@link de.fhkoeln.game.utils.Box2DMapObjectParser} with the given parameters and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param unitScale the {@link #unitScale unitScale} to use
	 *  @param tileWidth the {@link #tileWidth} to use
	 *  @param tileHeight the {@link #tileHeight} to use */
	...
	/** @param world the {@link com.badlogic.gdx.physics.box2d.World} in which to create the Body and Fixtures
	 *  @param object the {@link com.badlogic.gdx.maps.MapObject} to parse
	 *  @return the created Body
	 *  @see #createBody(com.badlogic.gdx.physics.box2d.World, com.badlogic.gdx.maps.MapObject)
	 *  @see #createFixtures(com.badlogic.gdx.maps.MapObject) */
	...
	/** {@link #createFixture(com.badlogic.gdx.maps.MapObject, com.badlogic.gdx.physics.box2d.Body) creates} the fixture from the given {@link com.badlogic.gdx.maps.MapObject} on the associated body in {@link #bodies}
	 *  @see #createFixture(com.badlogic.gdx.maps.MapObject, com.badlogic.gdx.physics.box2d.Body) */
	...
	/** {@link #createFixtures(com.badlogic.gdx.maps.MapObject, com.badlogic.gdx.physics.box2d.Body) creates} the fixtures from the given {@link com.badlogic.gdx.maps.MapObject} on the associated body in {@link #bodies}
	 *  @see #createFixtures(com.badlogic.gdx.maps.MapObject, com.badlogic.gdx.physics.box2d.Body) */
	...
	/** @param heritage the MapProperties in which to search for an {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases#body} property
	 *  @return the body associated with the given {@link com.badlogic.gdx.maps.MapObject} */
	...
	/** assigns the given {@link com.badlogic.gdx.maps.MapProperties properties} to the values of the given BodyDef
	 *  @param bodyDef the {@link com.badlogic.gdx.physics.box2d.BodyDef} which values to set according to the given {@link com.badlogic.gdx.maps.MapProperties}
	 *  @param properties the {@link com.badlogic.gdx.maps.MapProperties} to assign to the given {@link com.badlogic.gdx.physics.box2d.BodyDef} */
	...
	/** @see #assignProperties(com.badlogic.gdx.physics.box2d.BodyDef, com.badlogic.gdx.maps.MapProperties) */
	...
	/** @return the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} */
	public Aliases getAliases() {
		return aliases;
	}

	/** @param aliases the {@link de.fhkoeln.game.utils.Box2DMapObjectParser.Aliases} to set */
