...
/** provides methods for operations with Box2D {@link com.badlogic.gdx.physics.box2d.Body Bodies}, {@link com.badlogic.gdx.physics.box2d.Fixture Fixtures} and {@link com.badlogic.gdx.physics.box2d.Shape Shapes}
 *  @author dermetfan */
public abstract class Box2DUtils {
	...
	public static class ShapeCache {
		...
		/** @see de.fhkoeln.game.utils.Box2DUtils#vertices0(com.badlogic.gdx.physics.box2d.Shape) */
		public final Vector2[] vertices;

		/** @see de.fhkoeln.game.utils.Box2DUtils#width0(com.badlogic.gdx.physics.box2d.Shape) */
		public final float width;

		/** @see de.fhkoeln.game.utils.Box2DUtils#height0(com.badlogic.gdx.physics.box2d.Shape) */
		public final float height;

		/** @see de.fhkoeln.game.utils.Box2DUtils#minX0(com.badlogic.gdx.physics.box2d.Shape) */
		public final float minX;

		/** @see de.fhkoeln.game.utils.Box2DUtils#maxX0(com.badlogic.gdx.physics.box2d.Shape) */
		public final float maxX;

		/** @see de.fhkoeln.game.utils.Box2DUtils#minY0(com.badlogic.gdx.physics.box2d.Shape) */
	...
	/** Cached {@link com.badlogic.gdx.physics.box2d.Shape Shapes} and their {@link de.fhkoeln.game.utils.Box2DUtils.ShapeCache}. You should {@link com.badlogic.gdx.utils.ObjectMap#clear() clear} this when you don't use the shapes anymore. */
	...
	/** the area that is too small for a {@link com.badlogic.gdx.physics.box2d.PolygonShape} to contain it (limitation by Box2D) */
	public static final float minExclusivePolygonArea = 1.19209289550781250000e-7F;

	/** the max amount of vertices of a {@link com.badlogic.gdx.physics.box2d.PolygonShape} (limitation by Box2D) */
	...
	/** @param shape the Shape to create a new {@link de.fhkoeln.game.utils.Box2DUtils.ShapeCache} for that will be added to {@link #cache} */
	...
	/** @return a {@link com.badlogic.gdx.math.Vector2} representing the size of the given Shape */
	...
	/** @see #positionRelative(com.badlogic.gdx.physics.box2d.Shape, float)
	 *  @see com.badlogic.gdx.physics.box2d.CircleShape#getPosition() */
	...
	/** clones a {@link com.badlogic.gdx.physics.box2d.Body} (without deep copying the {@link com.badlogic.gdx.physics.box2d.Shape Shapes} of its {@link com.badlogic.gdx.physics.box2d.Fixture Fixtures})<br>
	 *  @return {@link #clone(com.badlogic.gdx.physics.box2d.Body, boolean) copy(body, false)}
	 *  @see #clone(com.badlogic.gdx.physics.box2d.Body, boolean) */
	public static Body clone(Body body) {
		return clone(body, false);
	}

	/** clones a {@link com.badlogic.gdx.physics.box2d.Body}
	 *  @param body the {@link com.badlogic.gdx.physics.box2d.Body} to copy
	 *  @param shapes if the {@link com.badlogic.gdx.physics.box2d.Shape Shapes} of the {@link com.badlogic.gdx.physics.box2d.Fixture Fixures} of the given {@code body} should be {@link #clone(com.badlogic.gdx.physics.box2d.Shape) copied} as well
	...
	/** clones a {@link com.badlogic.gdx.physics.box2d.Fixture} (without deep copying its {@link com.badlogic.gdx.physics.box2d.Shape})
	 *  @return {@link #clone(com.badlogic.gdx.physics.box2d.Fixture, com.badlogic.gdx.physics.box2d.Body, boolean) copy(fixture, body, false)}
	 *  @see #clone(com.badlogic.gdx.physics.box2d.Fixture, com.badlogic.gdx.physics.box2d.Body, boolean) */
	public static Fixture clone(Fixture fixture, Body body) {
		return clone(fixture, body, false);
	}

	/** clones a {@link com.badlogic.gdx.physics.box2d.Fixture}
	 *  @param fixture the {@link com.badlogic.gdx.physics.box2d.Fixture} to copy
	 *  @param body the {@link com.badlogic.gdx.physics.box2d.Body} to create a copy of the given {@code fixture} on
	 *  @param shape if the {@link com.badlogic.gdx.physics.box2d.Fixture#getShape() shape} of the given {@code fixture} should be deep {@link #clone(com.badlogic.gdx.physics.box2d.Shape) copied} as well
	 *  @return the copied {@link com.badlogic.gdx.physics.box2d.Fixture} */
	...
	/** creates a deep copy of a {@link com.badlogic.gdx.physics.box2d.Shape}<br>
	 *  <strong>Note: The {@link com.badlogic.gdx.physics.box2d.ChainShape#setPrevVertex(float, float) previous} and {@link com.badlogic.gdx.physics.box2d.ChainShape#setNextVertex(float, float) next} vertex of a {@link com.badlogic.gdx.physics.box2d.ChainShape} will not be copied since this is not possible due to the API.</strong>
	 *  @param shape the {@link com.badlogic.gdx.physics.box2d.Shape} to copy
	 *  @return a {@link com.badlogic.gdx.physics.box2d.Shape} exactly like the one passed in */
	...
	/** @param body the body for which to setup a new {@link com.badlogic.gdx.physics.box2d.BodyDef}
	 *  @return a new {@link com.badlogic.gdx.physics.box2d.BodyDef} instance that can be used to clone the given body */
	...
	/** @param fixture the fixture for which to setup a new {@link com.badlogic.gdx.physics.box2d.FixtureDef}
	 *  @return a new {@link com.badlogic.gdx.physics.box2d.FixtureDef} instance that can be used to clone the given fixture */
	 ...
	 *  @see #split(com.badlogic.gdx.physics.box2d.Shape, com.badlogic.gdx.math.Vector2, com.badlogic.gdx.math.Vector2, Pair) */
	 ...
	 *  @param a the first point of the segment
	 *  @param b the second point of the segment
	 *  @param store the {@link Pair} to store the resulting {@link com.badlogic.gdx.physics.box2d.FixtureDef FixtureDefs} in
	 *  @return if the fixture was split
	 *  @see #split(com.badlogic.gdx.physics.box2d.Shape, com.badlogic.gdx.math.Vector2, com.badlogic.gdx.math.Vector2, Pair) */
	...
	/** sets the {@link com.badlogic.gdx.physics.box2d.Fixture#isSensor() sensor flag} of all of the given Body's Fixtures
	 *  @param body the {@link com.badlogic.gdx.physics.box2d.Body} which {@link com.badlogic.gdx.physics.box2d.Fixture Fixtures'} sensor flag to set
	 *  @param sensor the parameter to pass to {@link com.badlogic.gdx.physics.box2d.Fixture#setSensor(boolean)}
	 *  @see com.badlogic.gdx.physics.box2d.Fixture#setSensor(boolean) */
	public static void setSensor(Body body, boolean sensor) {
		for(Fixture fixture : body.getFixtureList())
			fixture.setSensor(sensor);
	}

	/** {@link com.badlogic.gdx.physics.box2d.Body#destroyFixture(com.badlogic.gdx.physics.box2d.Fixture) destroys} all fixtures of the given body
	...
	/** {@link com.badlogic.gdx.physics.box2d.Body#destroyFixture(com.badlogic.gdx.physics.box2d.Fixture) destroys} all fixtures of the given body except the given ones
	...
	/** @see #destroyFixtures(com.badlogic.gdx.physics.box2d.Body, com.badlogic.gdx.utils.Array) */
